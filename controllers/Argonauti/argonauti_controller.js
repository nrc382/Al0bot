                    ...
                    if (line.match("chi sono")) {
                        ...
                        if (line.match("ciao") || line.match("salve") || line.match("buon")) {
                            ...
                            if (argoBool != null) {
                                ...
                                if (line.match("ci sei")) {
                                    let sed_array = [
                                        "E tu, ci sei?",
                                        "Qui per servire",
                                        "Sono mancato per molto?",
                                        "Mi son addorentato?",
...
function edollaroFormat(num) {
    ...
    if (tmp.substring(tmp.length - 2, tmp.length) == 0) {
...
function checkArgonaut(name, message) {
    for (let i = 0; i < globalArgonauts.length; i++) {
        if (typeof globalArgonauts[i].nick == 'string' && globalArgonauts[i].nick.toLowerCase() == name.toLowerCase()) {
